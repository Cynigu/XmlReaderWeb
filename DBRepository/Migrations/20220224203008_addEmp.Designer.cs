...
namespace XmlReader.Data.DBRepository.Migrations
{
    ...
    [Migration("20220224203008_addEmp")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.auth.AuthUser", b =>
                {
                    ...
                    b.Property<int?>("ThisEmployeeId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ThisEmployeeId");
            ...
            modelBuilder.Entity("Models.auth.AuthUser", b =>
                {
                    b.HasOne("Models.Employee", "ThisEmployee")
                        .WithMany()
                        .HasForeignKey("ThisEmployeeId");
